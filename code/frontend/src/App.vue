<template>
  ...
  <nav
    ...
    class="max-w-[75%] w-full mx-auto p-5 flex justify-between items-center bg-white shadow-md rounded-lg"
  >
    ...
    <div class="flex items-center gap-6">
      <div v-if="authStore.isLoggedIn" class="flex items-center">
        ...
        <div class="flex items-center gap-6">
          ...
          <div
            class="flex items-center gap-2 bg-indigo-50 px-3 py-1.5 rounded-full border border-indigo-100 shadow-sm"
          >
            <span class="text-lg">💰</span>
            <div class="flex flex-col leading-none">
              <span class="text-[9px] uppercase font-bold text-indigo-400 tracking-wider"
                >Saldo</span
              >
